...
namespace TorchMNIST
{
    ...
    public sealed class MNISTReader : IEnumerable<(Tensor, Tensor)>, IDisposable
    {
        ...
        public MNISTReader(string images, string labels, int batch_size = 32, bool shuffle = false, torch.Device device = null, ITransform transform = null)
        {
