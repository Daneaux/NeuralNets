...
namespace NeuralNets
{
    public abstract class NeuralNetworkAbstract
    {
        ...
        public abstract float GetAveragelLoss(TrainingPair tp, ColumnVector predicted);
        public abstract ColumnVector GetLossVector(TrainingPair tp, ColumnVector predicted);
        public abstract AvxColumnVector GetLossVector(TrainingPair tp, AvxColumnVector predicted);
        public abstract float GetTotallLoss(TrainingPair tp, ColumnVector predicted);
