...
namespace NeuralNetsTests.ANNTests
{
    ...
    public class ExampleAnn
    {
        ...
        public void SineWaveTest()
        {
            ...
            WeightedLayer hiddenLayer1 = new WeightedLayer(new InputOutputShape(1, 1, 1, 1), hiddenLayerDim);
            var act1 = new SigmoidActivation();
            WeightedLayer hiddenLayer2 = new WeightedLayer(hiddenLayer1.OutputShape, hiddenLayerDim);
            var act2 = new SigmoidActivation();
            WeightedLayer outputLayer = new WeightedLayer(hiddenLayer2.OutputShape, outputDim);
            var act3 = new SigmoidActivation();

            var layers = new List<Layer> { hiddenLayer1, act1, hiddenLayer2, act2, outputLayer, act3 };
        ...
        public void MattMazurExample()
        {
            ...
            WeightedLayer hiddenLayer = new WeightedLayer(shape, 2, w1, b1);
            SigmoidActivation act1 = new SigmoidActivation();
            WeightedLayer outputLayer = new WeightedLayer(shape, 2, w2, b2);
            SigmoidActivation act2 = new SigmoidActivation();
            ...
            GeneralFeedForwardANN ann = new GeneralFeedForwardANN(
                new List<Layer> { hiddenLayer, act1, outputLayer, act2 },
                trainingRate,
                inputDim,
                outputDim,
                new SquaredLoss());
        ...
        [TestMethod]
        public void MattMazurExample_newStyleLayers()
        {
            ...
            var hiddenLayer = new WeightedLayer(shape, 2, w1, b1);
            var act1 = new SigmoidActivation();
            var outputLayer = new WeightedLayer(shape, 2, w2, b2);
            var act2 = new SigmoidActivation();
