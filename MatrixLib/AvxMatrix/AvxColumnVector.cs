...
namespace MatrixLib
{
    public class AvxColumnVector : IColumnVector
    {
        ...
        {
            AvxColumnVector vector = new AvxColumnVector(this.Size);
        ...
        {
            if(other is AvxColumnVector vector)
                return this.AddVecVec(vector);
            throw new NotSupportedException("Add operation with non-AvxColumnVector backend not yet implemented");
        }
